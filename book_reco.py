...
pickle.dump(cf_recommender_model,open(filename,"wb"))
...
menu=["Recommendations","Datasets and information", "Visualization and EDA"]
...
if choice=="Recommendations":
    ...
    if button:
        ...
        recomend=model_recommender.recommend_book(cf_recommender_model,userid)
        #model_recommender.recommend_book(cf_recommender_model,userid)
        st.write(recomend)
       
    
elif choice=="Visualization and EDA":
    st.subheader("Visualization and EDA")
    st.text("Most Published Books")
    st.image("C:\\Users\\adite\\2022-11-03.png")
